...
const services = [
  ...
  'Websites & Domains',
  'Custom Applications',
  'AI Tools (Chatbots, Receptionist)',
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        className="w-full px-4 py-3 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-neutral-900 focus:border-transparent transition-colors bg-white"
                      >
